...
class santoi_contact extends \Elementor\Widget_Base
{

    public function get_name() {
        return 'santoi_contact';
    }

    public function get_title() {
        return esc_html__('Santoi Contact', 'santoi-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'info',
            [
                'label' => esc_html__('Contact Form Shortcode', 'textdomain'),
                'label_block' => true,
                'type' => \Elementor\Controls_Manager::TEXTAREA,
    
                'placeholder' => esc_html__('Type your cf7 shortcode here', 'textdomain'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em', 'rem', 'custom'],
                'selectors' => [
                    '{{WRAPPER}} .santoi_distort_images_ab_block canvas,
                    {{WRAPPER}} .st1-growing-img img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
    ...
    protected function render() {
        ...
        <section class="st1-growing-container">
                ...
                <div class="row gx-5">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="st1-growing-contain">
                            ...
                            <div class="has_fade_anim santoi-cf7-main-box">
			...
			<img  src="<?php echo $settings['section_img']['url']; ?>" alt="static image" />
                        </div>

                        <div class="st1-growing-img">
                            <?php if ($settings['section_img']['url']) { ?>
                            
                              <div class="santoi_distort_images_ab_block d-none d-md-flex">
...
\Elementor\Plugin::instance()->widgets_manager->register(new \santoi_contact());
