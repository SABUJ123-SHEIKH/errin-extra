<?php
namespace Elementor\Modules\SantoiTabs\Widgets;
...
class SantoiTabs extends Widget_Nested_Base {
	...
	public function get_title() {
		return esc_html__( 'Santoi Tabs', 'elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Make AI-Powered', 'textdomain'),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Images', 'textdomain'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('Couldnt find what you were looking for?Write to us at', 'textdomain'),
		...
		$this->start_controls_section( 'section_tabs_Wh_d', [
			'label' => esc_html__( 'All Box Style', 'elementor' ),
			...
			[
				...
				'exclude' => [ 'image' ],
				'selector' => '{{WRAPPER}} .elementor-widget-container .st1-tabs-contain-box',
				'fields_options' => [
				    'background' => [
						'label' => esc_html_x( 'Whole Tab Background Color', 'Background Control', 'elementor' ),
					],
   ...
   $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-widget-container .st1-tabs-contain-box' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'wh_box_height',
			[
				'label' => esc_html__( 'Whole Box Height', 'textdomain' ),
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-widget-container .st1-tabs-contain-box' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		
		$this->add_responsive_control(
			'img_wh_border_radius',
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-widget-container .st1-our-product-contain-img img,
					{{WRAPPER}} .elementor-widget-container .st1-our-product-contain-img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-widget-container .st1-our-product-contain-img img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'df_title_typography',
				'label' => esc_html__( 'Title Typogrphy', 'textdomain' ),
				'selector' => '{{WRAPPER}} .st1-our-product-contain-text h4',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{{WRAPPER}} .st1-our-product-contain-text h4' => 'color: {{VALUE}}',
				],
			]
		);
			...
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name' => 'df_sub_title_typography',
				'label' => esc_html__( 'Sub Title Typogrphy', 'textdomain' ),
				'selector' => '{{WRAPPER}} .st1-our-product-contain-text h2',
			]
		);
		$this->add_control(
			'df_sub_title_color',
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{{WRAPPER}} .st1-our-product-contain-text h2' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name' => 'df_sub_description_typography',
				'label' => esc_html__( 'Description Typogrphy', 'textdomain' ),
				'selector' => '{{WRAPPER}} .st1-our-product-contain-text p',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{{WRAPPER}} .st1-our-product-contain-text p' => 'color: {{VALUE}}',
				],
			]
		);
      ...
      $this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .e-n-tabs-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .e-n-tabs-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .e-n-tabs-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		?>
		  <div class="st1-our-product-contain">
                    <div class="st1-our-product-contain-text">
                        ...
                        <?php if ($settings['section_title']) { ?>
                            <h2 class="has_text_reveal_anim"><?php echo $settings['section_title']; ?></h2>
                        <?php } ?>
                    ...
                    <?php if ($settings['banner_img']['url']) { ?>
                        <div class="st1-our-product-contain-img img_anim_reveal">
                            <img src="<?php echo $settings['banner_img']['url']; ?>" alt="product.png" data-speed=".9">
                        </div>
                    <?php } ?>
                </div>
		<div class="st1-our-product-contain-box st1-tabs-contain-box">
		<div <?php $this->print_render_attribute_string( 'elementor-tabs' ); ?>>
        			...
        			<div class="e-n-tabs-content st1-product-item has_fade_anim">
	...
	protected function content_template() {
		...
		<h4 class="has_text_reveal_anim">{{{ settings.section_subtitle }}}</h4>
		
		<h2 class="has_text_reveal_anim">{{{ settings.section_title }}}</h2>
		      ...
		      <# 
		      var banner_img = {
				id: settings.banner_img.id,
				url: settings.banner_img.url,
				size: settings.image_size,
				dimension: settings.image_custom_dimension,
				model: view.getEditModel()
			};
		      
		      var image_url = elementor.imagesManager.getImageUrl( banner_img );
		      
		      #>
		      
		      
                        <div class="st1-our-product-contain-img">
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new SantoiTabs() );