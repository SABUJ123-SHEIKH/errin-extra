...
class ImgSelector_Control extends Base_Data_Control {
	...
	public function enqueue() {
		...
		$url = SANTOI_ELEMENTOR_PL_ROOT_URL.'assets/css/';
		// Styles
		wp_enqueue_style('icon-selector', $url.'icon-selector.css', array(), '');
		// wp_enqueue_script( 'santoi-elementor-selector', SANTOI_ELEMENTOR_PL_ROOT_URL . 'functions/elementor/includes/js/selectors.js', array('jquery'), PLUGIN_VERSION , true );
	}
