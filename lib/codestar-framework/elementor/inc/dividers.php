...
/* ---------------------------------------------------------------------------
  * Dividers [santoi_dividers]
  * --------------------------------------------------------------------------- */
if (!function_exists('sc_santoi_dividers')) {
	function sc_santoi_dividers($attr, $content = null) {
		...
		$el_id = 'santoi-accordion-' . rand(1, 1000000);
		$output = '';
		...
		if ($top_divider_select && $top_divider_select != '' && $top_divider_select != '0' && $top_divider_select != 'dynamic') {
			...
			$output .= santoi_get_divider($top_divider_select, $top_divider_color, 'top', $el_id, $top_moving_divider_color, $t_divider_opts, $c_height);
		}
		...
		if ($top_divider_select && $top_divider_select == 'dynamic') {
			...
			$output .= santoi_get_divider($top_divider_select, $top_divider_color, 'top', $el_id, $top_moving_divider_color, $t_divider_opts);
		}
		...
		if ($bottom_divider_select && $bottom_divider_select != '' && $bottom_divider_select != '0' && $bottom_divider_select != 'dynamic') {
			...
			$output .= santoi_get_divider($bottom_divider_select, $bottom_divider_color, 'bottom', $el_id, $bottom_moving_divider_color, $b_divider_opts, $c_height);
		}
		...
		if ($bottom_divider_select && $bottom_divider_select == 'dynamic') {
			...
			$output .= santoi_get_divider($bottom_divider_select, $bottom_divider_color, 'bottom', $el_id, $bottom_moving_divider_color, $b_divider_opts);
		}
...
add_shortcode('santoi_dividers', 'sc_santoi_dividers');