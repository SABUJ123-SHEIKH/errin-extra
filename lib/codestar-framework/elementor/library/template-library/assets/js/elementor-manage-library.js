   ...
   'use strict';
    ...
    SANTOILIB = {
        ...
        init: function () {
            ...
            window.elementor.on(
                'document:loaded',
                window._.bind(SANTOILIB.onPreviewLoaded, SANTOILIB)
            );
        },
        ...
        onPreviewLoaded: function () {
            ...
            var wrapper_html = "<div style='display:none;' class='lib-wrap'>"
                                    +"<div class='lib-inner'>"
                                        +"<div class='header'>"
                                            +"<div class='lhead'>"
                                                +"<h2 class='lib-logo'>Santoi Library</h2>"
            ...
            main_wrap.find('.elementor-add-template-button').after("<div class='elementor-add-section-area-button xltab-add-section-btn' style='background:#fff;margin-left:10px;vertical-align:middle;box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;padding:10px;'><img src='https://api.themepreview.xyz/santoi/wp-content/uploads/2022/12/Rectangle-3161-1.svg' style='width:24px;'></div>");
            ...
            $(document).on('click', '.insert-tmpl', function(e) {
                ...
                $.ajax({
                    ...
                    url: ajaxurl,
                    data: {
                      action: 'santoi_lib_import_template',
                      id: tmpl_id,
                    },
            ...
            $(document).on('click', '.rhead .eicon-sync', function(e) {
                ...
                $.ajax({
                    ...
                    url: ajaxurl,
                    data: {
                      action: 'santoi_lib_reload_template',
                    },
                    success: function(data, textStatus, XMLHttpRequest) {
                        $('.xl-loader').hide();
                        var ajax_data = {
    ...
    $(window).on('elementor:init', SANTOILIB.init);
