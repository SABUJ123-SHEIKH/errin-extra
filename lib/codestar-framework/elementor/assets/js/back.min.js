jQuery(window).on("elementor/frontend/init", () => {
    function d(o, t, i, d = !1, e = !1, l = [], r = !1) {
        let a = santoi_elementor_object.santoi_shapes,
            _ = "santoi-divider ",
            s =
                (0 == r && (r = !1),
                (_ += " position-absolute santoi-divider-in-elementor "),
                (container_style = ""),
                (container_style = "top" == i ? ((_ += "santoi-top-divider"), 'style="top:-1px;"') : ((_ += "santoi-bottom-divider"), 'style="bottom:-1px;"')),
                l.d_high_index && (_ += " santoi-divider-in-front"),
                l.d_flip_h && (_ += " santoi-divider-flip-h"),
        ...
        if (((output = '<div class="' + _ + '" data-style="style-' + o + '" ' + container_style + ">"), "dynamic" == l.d_divider_select)) {
            ...
            (dynamic = '<div class="santoi-dividers-box" ' + _ + ">"),
                (dynamic = (dynamic = (dynamic += '<svg class="santoi-shape-dividers" ' + _ + ' viewBox="0 0 100 100" preserveAspectRatio="none">') + ("<defs>" + c + "</defs>" + p)) + "</svg>" + "</div>"),
                (output += dynamic);
        } else output += s;
        return (output += "</div>");
    }
    var _ = (_) => {
        ...
        if (void 0 !== i && !1 !== i) {
            ...
            var i = Math.floor(1e5 * Math.random()),
                o = t.santoi_sticky_top;
            if (
                (o &&
                    "true" === o &&
                    ((o = 20),
                    0 < $(".santoi-enable-sticky, .santoi-is-sticky-header").length && ((o = $(".santoi-header").height()), 0 < $("#masthead").length && ($("#masthead").hasClass("santoi-header-box") ? (o += 20) : (o += 10))),
                    _.addClass("sticky-top santoi-sticky-top-adjust"),
                    _.css({ top: o })),
            ...
            (o ? _.find("> .elementor-column-wrap > .santoi-divider") : _.find("> .santoi-divider")).remove(),
                e &&
                    "" !== e &&
                    ((o ? _.find("> .elementor-column-wrap") : _).prepend(e),
                    
                    _.find(".santoi-shape-dividers").each(function () {
